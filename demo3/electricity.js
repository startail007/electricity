import { rotate, toPosRate, pushVector } from "./vector.js";
import { setShadow, clearShadow, numberCrop, randomSeedList } from "./base.js";
class ElectricityData {
  ...
  setPosToLineData(data, p0, p1) {
    ...
    for (let i = 0, len = data.length; i < len; i++) {
      posList[i] = pushVector(rotate(data[i], angle), toPosRate(p0, p1, i / (len - 1)));
    }
    return posList;
  }
}
